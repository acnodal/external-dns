...
func NewCRDSource(crdClient dynamic.Interface, namespace, version, resource string, annotationFilter string, labelSelector labels.Selector) (Source, error) {
...
// List queries the server for the user-specified resources
// and converts them into DNSEndpoint objects.
func (cs *crdSource) List(ctx context.Context, opts *metav1.ListOptions) ([]endpoint.DNSEndpoint, error) {
	rawEndpoints, err := cs.crdClient.
